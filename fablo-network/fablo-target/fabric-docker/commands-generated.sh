...
installChaincodes() {
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/../trackmeat")" ]; then
    ...
    chaincodeApprove "cli.farmer.example.com" "peer0.farmer.example.com:7041" "agridata" "trackmeat" "$version" "orderer0.group1.root.com:7030" "" "false" "crypto-orderer/tlsca.root.com-cert.pem" ""
    ...
    chaincodeApprove "cli.auditor.example.com" "peer0.auditor.example.com:7061" "agridata" "trackmeat" "$version" "orderer0.group1.root.com:7030" "" "false" "crypto-orderer/tlsca.root.com-cert.pem" ""
    ...
    chaincodeApprove "cli.transporter.example.com" "peer0.transporter.example.com:7081" "agridata" "trackmeat" "$version" "orderer0.group1.root.com:7030" "" "false" "crypto-orderer/tlsca.root.com-cert.pem" ""
